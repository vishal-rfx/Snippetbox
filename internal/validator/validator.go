...
// a 'compiled' regexp.Regexp type, or panics in the event of an error. Parsing this
// pattern once at startup and storing the compiled *regexp.Regexp in a variable is more performant than re-parsing
...
// Add a NonFieldErrors []string to the struct, which we will use to hold any validation errors which are not related
